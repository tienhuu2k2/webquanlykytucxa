...
<body>
    <form method="POST" action="http://localhost/New-MVC/Qlhoadon/Update_hd">
        <table>
            ...
            <tr>
                ...
                <td class="col2">
                    <select class="dd2" name="ddthang">
                        ...
                        <option value="11" <?php if(isset($data['thang']) && $data['thang']=="11"){echo 'selected';}else{if($thang=="12"){echo 'selected';}} ?>>Tháng 11</option>
                        <option value="12" <?php if(isset($data['thang']) && $data['thang']=="12"){echo 'selected';}else{if($thang=="13"){echo 'selected';}} ?>>Tháng 12</option>
                    </select>
                </td>
